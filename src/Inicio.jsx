...
// Rutas directas de iconos (sin imports Webpack)
const ICONOS = {
...
// Tarjeta de mascota memoizada: solo re-renderiza si cambian sus props
...
function Inicio() {
  ...
  return (
    <div className="bg-[#F2F7FD] min-h-screen pt-[72px] pb-[80px]">
      
      {/* CABECERA fija */}
      <header className="bg-[#61C5B8] fixed top-0 left-0 w-full h-[60px] z-[100] rounded-b-[15px] px-5">
      ...
      <main className="px-5 max-w-[1200px] mx-auto">
        ...
        <div className="bg-[#61C5B8] rounded-[15px] p-5 text-white mb-[25px]">
          ...
          <h2 className="text-[22px] font-bold mb-1">Bienvenido...!</h2>
          ...
          {mascotas.length === 0 ? (
            ...
            <>
              <div className="grid grid-cols-[repeat(auto-fit,minmax(130px,1fr))] gap-[15px]">
                <TarjetaMascota key={mascotaVisible.id} mascota={mascotaVisible} onEliminar={setMascotaAEliminar} />
                <Link to="/agregar-mascota" className="border-2 border-dashed border-[#A4B0BE] rounded-[15px] p-[15px] flex flex-col items-center justify-center text-center no-underline text-[#A4B0BE] font-bold text-[13px] gap-2.5 bg-transparent min-h-[145px] hover:bg-white transition-colors">
              ...
              <div className="flex justify-center mt-6">
                <Link to="/mis-mascotas" className="text-[#61C5B8] font-bold text-sm no-underline hover:underline">Ver todas mis mascotas</Link>
              </div>
            </>
          )}
        </section>
        ...
        <section className="mb-[30px]">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(130px,1fr))] gap-[15px]">
            ...
            <div className="bg-[#EAEFF5] rounded-[15px] py-5 px-2.5 flex flex-col items-center justify-center gap-2.5 font-bold text-lg text-[#DE7D7A]">
              <Icono name={ICONOS.cuidado} alt="Servicio de cuidado" className="w-20 h-20" width="80" height="80" />
              <p>Cuidado</p>
            </div>

            <div className="bg-[#EAEFF5] rounded-[15px] py-5 px-2.5 flex flex-col items-center justify-center gap-2.5 font-bold text-lg text-[#16A085]">
              <Icono name={ICONOS.limpieza} alt="Servicio de limpieza" className="w-20 h-20" width="80" height="80" />
              <p>Limpieza</p>
            </div>

            <div className="bg-[#EAEFF5] rounded-[15px] py-5 px-2.5 flex flex-col items-center justify-center gap-2.5 font-bold text-lg text-[#5C85D6]">
              <Icono name={ICONOS.paseos} alt="Servicio de paseos" className="w-20 h-20" width="80" height="80" />
              <p>Paseos</p>
            </div>

            <div className="bg-[#EAEFF5] rounded-[15px] py-5 px-2.5 flex flex-col items-center justify-center gap-2.5 font-bold text-lg text-[#4FB0A4]">
              <Icono name={ICONOS.veterinaria} alt="Servicio de veterinaria" className="w-20 h-20" width="80" height="80" />
              <p>Veterinaria</p>
            </div>
          </div>
        </section>
